...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(Game_i))==(get_game_over,init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play);
  List_Operations(Implementation(Game_i))==(get_game_over,init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(Game_i)) == (? | ? | ? | ? | get_game_over,init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play | ? | seen(Machine(Game_cards)) | ? | Game_i);
