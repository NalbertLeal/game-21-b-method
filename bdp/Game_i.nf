...
&
THEORY ListSeesX IS
  List_Sees(Implementation(Game_i))==(Game_cards,Game_ctx)
END
&
...
THEORY ListInstanciatedParametersX IS
  ...
  List_Instanciated_Parameters(Implementation(Game_i),Machine(Game_ctx))==(?)
END
&
...
THEORY ListOperationsX IS
  Internal_List_Operations(Implementation(Game_i))==(init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play);
  List_Operations(Implementation(Game_i))==(init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play)
END
&
...
THEORY ListSubstitutionX IS
  Expanded_List_Substitution(Implementation(Game_i),player_two_play)==(game_over = FALSE & deck/={} & player_one_hand/={} & player_two_hand/={} & player_one_points>0 & player_two_points>0 & top_deck/=(NOTYPE|->NOVALUE) & top_deck_points>0 & current_player = P_TWO & discart: seq(ran(discart)) & discart<-top_deck: seq(PLAYABLE) & discart<-top_deck: FIN(discart<-top_deck) & (not(top_deck_points+player_two_points<22) => size(discart<-top_deck)<=52) | @value.((top_deck_points_i+player_two_points_i: INT & top_deck_points_i: INT & player_two_points_i: INT | value:=top_deck_points_i+player_two_points_i);(value<22 ==> ((value: INT | player_two_points_i:=value);(player_two_points_i = 21 ==> game_over_i:=TRUE [] not(player_two_points_i = 21) ==> game_over_i:=FALSE)) [] not(value<22) ==> ((top_deck_i: dom(discart_i) | discart_i:=discart_i<+{top_deck_i|->TRUE});(top_deck_i: dom(deck_i) | deck_i:=deck_i<+{top_deck_i|->FALSE}))));current_player_i:=P_ONE;(-1: INT & 0: INT & 1: INT | top_deck_i:= -1);(0: INT | top_deck_points_i:=0));
  Expanded_List_Substitution(Implementation(Game_i),player_one_play)==(game_over = FALSE & deck/={} & player_one_hand/={} & player_two_hand/={} & player_one_points>0 & player_two_points>0 & top_deck/=(NOTYPE|->NOVALUE) & top_deck_points>0 & current_player = P_ONE & discart: seq(ran(discart)) & discart<-top_deck: seq(PLAYABLE) & discart<-top_deck: FIN(discart<-top_deck) & (not(top_deck_points+player_one_points<22) => size(discart<-top_deck)<=52) | @value.((top_deck_points_i+player_one_points_i: INT & top_deck_points_i: INT & player_one_points_i: INT | value:=top_deck_points_i+player_one_points_i);(value<22 ==> ((value: INT | player_one_points_i:=value);(player_one_points_i = 21 ==> game_over_i:=TRUE [] not(player_one_points_i = 21) ==> game_over_i:=FALSE)) [] not(value<22) ==> ((top_deck_i: dom(discart_i) | discart_i:=discart_i<+{top_deck_i|->TRUE});(top_deck_i: dom(deck_i) | deck_i:=deck_i<+{top_deck_i|->FALSE}))));current_player_i:=P_TWO;(-1: INT & 0: INT & 1: INT | top_deck_i:= -1);(0: INT | top_deck_points_i:=0));
...
THEORY ListSeenInfoX IS
  Seen_Internal_List_Operations(Implementation(Game_i),Machine(Game_ctx))==(?);
  ...
  Seen_List_Operations(Implementation(Game_i),Machine(Game_ctx))==(?);
  Seen_Expanded_List_Invariant(Implementation(Game_i),Machine(Game_ctx))==(btrue);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Implementation(Game_i)) == (? | ? | ? | ? | init_deck,init_hands,init_hands_points,update_top_deck,reset_deck,player_one_play,player_two_play | ? | seen(Machine(Game_cards)),seen(Machine(Game_ctx)) | ? | Game_i);
